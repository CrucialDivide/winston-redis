...
var Redis = exports.Redis = function (options) {
  ...
  this.channelAsContainer = options.channelAsContainer || false;
...
Redis.prototype.log = function (level, msg, meta, callback) {
  ...
  if (_.isObject(msg) && _.isEmpty(meta)) {
    meta = msg;
    msg = "";
  }

  if (this.channelAsContainer==true) {
    console.log("channelAsContainer: ", meta);
    if (meta.channel) {
      container = meta.channel;
    }
  }
